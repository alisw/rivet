...
XLabel=$x_\mathrm{E}$
YLabel=$\frac{1}{N_\mathrm{jet}^\mathrm{udsc}(Q_\mathrm{jet})}\frac{dN_\mathrm{ch}}{dx_\mathrm{E}}$
# END PLOT

# BEGIN PLOT /OPAL_2004_I648738/d06-x01-y02
Title=b durham jet fragmentation, $Q_\mathrm{jet}=4.0-9.0~\mathrm{GeV}$
XLabel=$x_\mathrm{E}$
YLabel=$\frac{1}{N_\mathrm{jet}^\mathrm{b}(Q_\mathrm{jet})}\frac{dN_\mathrm{ch}}{dx_\mathrm{E}}$
# END PLOT

# BEGIN PLOT /OPAL_2004_I648738/d06-x01-y03
Title=gluon durham jet fragmentation, $Q_\mathrm{jet}=4.0-9.0~\mathrm{GeV}$
XLabel=$x_\mathrm{E}$
YLabel=$\frac{1}{N_\mathrm{jet}^\mathrm{gluon}(Q_\mathrm{jet})}\frac{dN_\mathrm{ch}}{dx_\mathrm{E}}$
# END PLOT
