...
Title=Leading jet $p_{T}$, $N_{jets} \geq 0$
XLabel=$p_{T}^{j1}$ [GeV]
YLabel=$\mathrm{d}\sigma_{\mathrm{fid}} / \mathrm{d} p_T$ [fb/GeV]
LogY=1
# END PLOT
...
Title=Leading jet rapidity, $N_{jets} \geq 1$, $p_T^{jet} > 30$ GeV
XLabel=$|y_{j1}|$
...
Title=Scalar sum of jet transverse momenta, $N_{jets} \geq 0$
XLabel=$H_T$ [GeV]
...
Title=Subleading jet $p_{T}$, $N_{jets} \geq 1$
XLabel=$p_{T}^{j2}$ [GeV]
YLabel=$\mathrm{d}\sigma_{\mathrm{fid}} / \mathrm{d} p_T$ [fb/GeV]
LogY=1
# END PLOT
...
Title=Dijet rapidity separation, $N_{jets} \geq 2$, $p_T^{jet} > 30$ GeV
XLabel=$|\Delta y_{jj}|$
...
Title=$\Delta \phi$ between dijet and diphoton systems, $N_{jets} \geq 2$, $p_T^{jet} > 30$ GeV
...
Title=Azimuthal angle between the leading jets, $N_{jets} \geq 2$, $p_T^{jet} > 30$ GeV
...
Title=Beam-thrust-like variable for leading jet, $N_{jet} \geq 0$,$p_T^{jet} > 25$ GeV
XLabel=$\tau_{1}$ [GeV]
...
Title=Sum of beam-thrust-like variables for jets, $N_{jet} \geq 0$,$p_T^{jet} > 25$ GeV
...
Title=Subleading jet rapidity,  $N_{jet} \geq 2$,$p_T^{jet} > 30$ GeV
XLabel=$|y_{j2}|$
...
Title=Third-leading jet transverse momentum,  $N_{jet} \geq 2$, $p_T^{jet} > 30$ GeV
XLabel=$|p_T^{j3}|$ [GeV]
...
Title=Dijet invariant mass,  $N_{jet} \geq 2$, $p_T^{jet} > 30$ GeV
XLabel=$m_{jj}$ [GeV]
...
Title=$p_T$ of diphoton-dijet system,  $N_{jet} \geq 2$, $p_T^{jet} > 30$ GeV
...
Title=Diphoton transverse momentum, $N_{jet} \geq 2$
XLabel=$p_T^{\gamma\gamma}$ [GeV]
YLabel=$\mathrm{d}\sigma_{\mathrm{fid}} / \mathrm{d} p_T^{\gamma\gamma}$ [fb/GeV]
LogY=0
# END PLOT
...
Title=Baseline, $N_{jets} \geq 1, 2, 3$, VBF, $N_{lep} \geq 1$, $E_T^{miss} \geq 80$ GeV regions
XLabel=region ID
YLabel=$\sigma_{\mathrm{fid}}$ [fb]
LogY=1
# END PLOT
