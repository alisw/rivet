...
Title=$E^e_{\mathrm{T}}(p^\mu_{\mathrm{T}})$ for the $2^\mathrm{nd}$ leading lepton
XLabel=$E^e_{\mathrm{T}}(p^\mu_{\mathrm{T}})$ [GeV]
YLabel=$\mathrm{Events}/10 \mathrm{GeV}$
LogY=1
# END PLOT
# BEGIN PLOT /ATLAS_2012_CONF_2012_001/d03-x01-y01
Title=$E^e_{\mathrm{T}}(p^\mu_{\mathrm{T}})$ for the  $3^\mathrm{rd}$ leading lepton
XLabel=$E^e_{\mathrm{T}}(p^\mu_{\mathrm{T}})$ [GeV]
YLabel=$\mathrm{Events}/5 \mathrm{GeV}$
LogY=1
# END PLOT
# BEGIN PLOT /ATLAS_2012_CONF_2012_001/d04-x01-y01
Title=$E^e_{\mathrm{T}}(p^\mu_{\mathrm{T}})$ for the  $4^\mathrm{th}$ leading lepton
XLabel=$E^e_{\mathrm{T}}(p^\mu_{\mathrm{T}})$ [GeV]
YLabel=$\mathrm{Events}/5 \mathrm{GeV}$
LogY=1
# END PLOT
