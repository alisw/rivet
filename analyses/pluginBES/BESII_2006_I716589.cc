...
namespace Rivet {
  ...
  /// @brief psi(2S) -> p nbar pi+ + c.c
  class BESII_2006_I716589 : public Analysis {
  public:

    /// Constructor
    RIVET_DEFAULT_ANALYSIS_CTOR(BESII_2006_I716589);
	...
	book(_h[ix],1,1,1+ix);
	book(_dalitz[ix], "dalitz_"+toString(ix+1),50,1.,8.,50,1.,8.);
      }
    }
  ...
  RIVET_DECLARE_PLUGIN(BESII_2006_I716589);
