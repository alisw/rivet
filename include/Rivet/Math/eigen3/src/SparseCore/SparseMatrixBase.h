  ...
  : public EigenBase<Derived>
{
  public:
    ...
    typedef typename internal::conditional<NumTraits<Scalar>::IsComplex,
                        CwiseUnaryOp<internal::scalar_conjugate_op<Scalar>, RivetEigen::Transpose<const Derived> >,
...
#define EIGEN_CURRENT_STORAGE_BASE_CLASS RivetEigen::SparseMatrixBase
