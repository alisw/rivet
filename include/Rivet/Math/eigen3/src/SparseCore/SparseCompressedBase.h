  ...
  : public SparseMatrixBase<Derived>
{
  ...
  protected:
    ...
    RivetEigen::Map<IndexVector> innerNonZeros() { return RivetEigen::Map<IndexVector>(innerNonZeroPtr(), isCompressed()?0:derived().outerSize()); }
    const  RivetEigen::Map<const IndexVector> innerNonZeros() const { return RivetEigen::Map<const IndexVector>(innerNonZeroPtr(), isCompressed()?0:derived().outerSize()); }
