        ...
        : public SolverBase<ColPivHouseholderQR<_MatrixType> >
{
  ...
  public:
    ...
    */
    ...
    /** \brief Constructs a QR factorization from a given matrix
      *
      * This overloaded constructor is provided for \link InplaceDecomposition inplace decomposition \endlink when \c MatrixType is a RivetEigen::Ref.
      *
    ...
    /** Allows to come back to the default behavior, letting Eigen use its default formula for
      ...
      * \code qr.setThreshold(RivetEigen::Default); \endcode
      *
