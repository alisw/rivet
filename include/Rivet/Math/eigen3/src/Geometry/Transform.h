...
struct traits<Transform<_Scalar,_Dim,_Mode,_Options> >
{
  ...
  typedef RivetEigen::Index StorageIndex;
...
private:
  ...
  //   error: template instantiation resulted in unexpected function type of "RivetEigen::Transform<double, 3, 32, 0>
  //             (const RivetEigen::Transform<double, 3, 2, 0> &) const"
  //  (the meaning of a name may have changed since the template declaration -- the type of the template is:
  // "RivetEigen::internal::transform_transform_product_impl<RivetEigen::Transform<double, 3, 32, 0>,
  //     RivetEigen::Transform<double, 3, Mode, Options>, <expression>>::ResultType (const RivetEigen::Transform<double, 3, Mode, Options> &) const")
  //
