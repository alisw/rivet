...
///
/// The number of rows \a nRows and columns \a nCols can also be specified at compile-time by passing RivetEigen::fix<N>,
...
/// that the other size is passed at compile-time using RivetEigen::fix<N> as above.
///
