...
/**
  ...
  *  - RivetEigen::all indexing the full set of respective rows or columns in increasing order
  *  - An ArithmeticSequence as returned by the RivetEigen::seq and RivetEigen::seqN functions
  ...
  * \endcode
  * where \c <integral \c type>  stands for any integer type compatible with RivetEigen::Index (i.e. \c std::ptrdiff_t).
  *
  ...
  *  - An integer
  *  - RivetEigen::all
  *  - An ArithmeticSequence with compile-time increment strictly equal to 1, as returned by RivetEigen::seq(a,b), and RivetEigen::seqN(a,N).
  *
