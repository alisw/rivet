...
/// \newin{3.4}:
///
/// The number of rows \a blockRows and columns \a blockCols can also be specified at compile-time by passing RivetEigen::fix<N>,
/// or RivetEigen::fix<N>(n) as arguments. In the later case, \c n plays the role of a runtime fallback value in case \c N equals RivetEigen::Dynamic.
...
///
/// The number of rows \a blockRows and columns \a blockCols can also be specified at compile-time by passing RivetEigen::fix<N>,
/// or RivetEigen::fix<N>(n) as arguments. See \link block(Index,Index,NRowsType,NColsType) block() \endlink for the details.
///
EIGEN_DOC_BLOCK_ADDONS_NOT_INNER_PANEL
///
...
///
/// The number of rows \a n can also be specified at compile-time by passing RivetEigen::fix<N>,
/// or RivetEigen::fix<N>(n) as arguments.
...
///
/// The number of columns \a n can also be specified at compile-time by passing RivetEigen::fix<N>,
/// or RivetEigen::fix<N>(n) as arguments.
/// See \link block(Index,Index,NRowsType,NColsType) block() \endlink for the details.
///
...
///
/// The number of coefficients \a n can also be specified at compile-time by passing RivetEigen::fix<N>,
/// or RivetEigen::fix<N>(n) as arguments.
/// See \link block(Index,Index,NRowsType,NColsType) block() \endlink for the details.
///
/// \note Even in the case that the returned expression has dynamic size, in the case
