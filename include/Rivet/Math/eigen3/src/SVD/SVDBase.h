...
public: 
  ...
  typedef typename RivetEigen::internal::traits<SVDBase>::StorageIndex StorageIndex;
   ...
   * the U matrix is n-by-n if you asked for \link RivetEigen::ComputeFullU ComputeFullU \endlink, and is n-by-m if you asked for \link RivetEigen::ComputeThinU ComputeThinU \endlink.
   *
   ...
   *
   * For the SVD decomposition of a n-by-p matrix, letting \a m be the minimum of \a n and \a p,
   * the V matrix is p-by-p if you asked for \link RivetEigen::ComputeFullV ComputeFullV \endlink, and is p-by-m if you asked for \link RivetEigen::ComputeThinV ComputeThinV \endlink.
   *
  ...
  /** Allows to come back to the default behavior, letting Eigen use its default formula for
    ...
    *
    * You should pass the special object RivetEigen::Default as parameter here.
    * \code svd.setThreshold(RivetEigen::Default); \endcode
    *
