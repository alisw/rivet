...
void BDCSVD<MatrixType>::allocate(RivetEigen::Index rows, RivetEigen::Index cols, unsigned int computationOptions)
{
...
template<typename MatrixType>
void BDCSVD<MatrixType>::divide(RivetEigen::Index firstCol, RivetEigen::Index lastCol, RivetEigen::Index firstRowW, RivetEigen::Index firstColW, RivetEigen::Index shift)
{
...
template <typename MatrixType>
void BDCSVD<MatrixType>::computeSVDofM(RivetEigen::Index firstCol, RivetEigen::Index n, MatrixXr& U, VectorType& singVals, MatrixXr& V)
{
  const RealScalar considerZero = (std::numeric_limits<RealScalar>::min)();
  using std::abs;
...
template <typename MatrixType>
void BDCSVD<MatrixType>::deflation43(RivetEigen::Index firstCol, RivetEigen::Index shift, RivetEigen::Index i, RivetEigen::Index size)
{
  using std::abs;
  using std::sqrt;
  using std::pow;
...
template <typename MatrixType>
void BDCSVD<MatrixType>::deflation44(RivetEigen::Index firstColu , RivetEigen::Index firstColm, RivetEigen::Index firstRowW, RivetEigen::Index firstColW, RivetEigen::Index i, RivetEigen::Index j, RivetEigen::Index size)
{
  using std::abs;
  using std::sqrt;
  using std::conj;
...
template <typename MatrixType>
void BDCSVD<MatrixType>::deflation(RivetEigen::Index firstCol, RivetEigen::Index lastCol, RivetEigen::Index k, RivetEigen::Index firstRowW, RivetEigen::Index firstColW, RivetEigen::Index shift)
{
  using std::sqrt;
  using std::abs;
