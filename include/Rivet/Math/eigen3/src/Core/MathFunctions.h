...
#define EIGEN_MATHFUNC_IMPL(func, scalar) RivetEigen::internal::func##_impl<typename RivetEigen::internal::global_math_functions_filtering_base<scalar>::type>
#define EIGEN_MATHFUNC_RETVAL(func, scalar) typename RivetEigen::internal::func##_retval<typename RivetEigen::internal::global_math_functions_filtering_base<scalar>::type>::type
