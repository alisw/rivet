...
#endif // not EIGEN_PARSED_BY_DOXYGEN
{
  public:
    ...
    /** Inner iterator type to iterate over the coefficients of a row or column.
      ...
      */
    typedef RivetEigen::InnerIterator<Derived> InnerIterator;
    ...
    /**
      ...
      *          PermutationMatrix or Transpositions, otherwise it defaults to RivetEigen::Index
      * \sa \blank \ref TopicPreprocessorDirectives, RivetEigen::Index, SparseMatrixBase.
     */
...
#define EIGEN_CURRENT_STORAGE_BASE_CLASS RivetEigen::DenseBase
