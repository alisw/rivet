...
struct solve_assertion<CwiseUnaryOp<RivetEigen::internal::scalar_conjugate_op<Scalar>, const Transpose<Derived> > >
{
    typedef CwiseUnaryOp<RivetEigen::internal::scalar_conjugate_op<Scalar>, const Transpose<Derived> > type;
