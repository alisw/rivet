...
/** \namespace RivetRivetEigen::symbolic
  * \ingroup Core_Module
  *
  ...
  * \endcode
  *
  * It is currently only used internally to define and manipulate the RivetEigen::last and RivetEigen::lastp1 symbols in RivetEigen::seq and RivetEigen::seqN.
  *
  */
namespace symbolic {
