...
// its corresponding packet_traits<RivetEigen::half> must be visible on host.
#if defined(EIGEN_HAS_CUDA_FP16) || defined(EIGEN_HAS_HIP_FP16)

typedef ulonglong2 Packet4h2;
template<> struct unpacket_traits<Packet4h2> { typedef RivetEigen::half type; enum {size=8, alignment=Aligned16, vectorizable=true, masked_load_available=false, masked_store_available=false}; typedef Packet4h2 half; };
template<> struct is_arithmetic<Packet4h2> { enum { value = true }; };

template<> struct unpacket_traits<half2> { typedef RivetEigen::half type; enum {size=2, alignment=Aligned16, vectorizable=true, masked_load_available=false, masked_store_available=false}; typedef half2 half; };
template<> struct is_arithmetic<half2> { enum { value = true }; };

template<> struct packet_traits<RivetEigen::half> : default_packet_traits
{
...
template<>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 pset1<half2>(const RivetEigen::half& from) {
#if defined(EIGEN_GPU_COMPILE_PHASE)
...
pset1<Packet4h2>(const RivetEigen::half& from) {
  Packet4h2 r;
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 pload(const RivetEigen::half* from) {
  return *reinterpret_cast<const half2*>(from);
}

EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 ploadu(const RivetEigen::half* from) {
  return combine_half(from[0], from[1]);
}

EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 ploaddup(const RivetEigen::half*  from) {
  return combine_half(from[0], from[0]);
}

EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE void pstore(RivetEigen::half* to,
                                                  const half2& from) {
  *reinterpret_cast<half2*>(to) = from;
}

EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE void pstoreu(RivetEigen::half* to,
                                                   const half2& from) {
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 pgather(const RivetEigen::half* from,
                                                    Index stride) {
  return combine_half(from[0*stride], from[1*stride]);
}

EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE void pscatter(
    RivetEigen::half* to, const half2& from, Index stride) {
  to[stride*0] = get_half2_low(from);
  to[stride*1] = get_half2_high(from);
}

EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE RivetEigen::half pfirst(const half2& a) {
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE half2 plset(const RivetEigen::half& a) {
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE RivetEigen::half predux(const half2& a) {
#if defined(EIGEN_GPU_HAS_FP16_ARITHMETIC)
  return __hadd(__low2half(a), __high2half(a));
#else
  float a1 = __low2float(a);
  float a2 = __high2float(a);
  return RivetEigen::half(__float2half(a1 + a2));
#endif
}

EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE RivetEigen::half predux_max(const half2& a) {
#if defined(EIGEN_GPU_HAS_FP16_ARITHMETIC)
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE RivetEigen::half predux_min(const half2& a) {
#if defined(EIGEN_GPU_HAS_FP16_ARITHMETIC)
  __half first = __low2half(a);
  __half second = __high2half(a);
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE RivetEigen::half predux_mul(const half2& a) {
#if defined(EIGEN_GPU_HAS_FP16_ARITHMETIC)
...
template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Packet4h2
pload<Packet4h2>(const RivetEigen::half* from) {
...
template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Packet4h2
ploadu<Packet4h2>(const RivetEigen::half* from) {
  Packet4h2 r;
  half2* p_alias = reinterpret_cast<half2*>(&r);
...
template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Packet4h2
ploaddup<Packet4h2>(const RivetEigen::half* from) {
  Packet4h2 r;
  half2* p_alias = reinterpret_cast<half2*>(&r);
...
template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE void pstore<RivetEigen::half>(
    RivetEigen::half* to, const Packet4h2& from) {
  *reinterpret_cast<Packet4h2*>(to) = from;
}

template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE void pstoreu<RivetEigen::half>(
    RivetEigen::half* to, const Packet4h2& from) {
...
ploadt_ro<Packet4h2, Aligned>(const RivetEigen::half* from) {
#if defined(EIGEN_GPU_HAS_LDG)
  Packet4h2 r;
...
template <>
EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE Packet4h2
ploadt_ro<Packet4h2, Unaligned>(const RivetEigen::half* from) {
  Packet4h2 r;
  half2* r_alias = reinterpret_cast<half2*>(&r);
...
template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Packet4h2
pgather<RivetEigen::half, Packet4h2>(const RivetEigen::half* from, Index stride) {
  Packet4h2 r;
  half2* p_alias = reinterpret_cast<half2*>(&r);
...
template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE void pscatter<RivetEigen::half, Packet4h2>(
    RivetEigen::half* to, const Packet4h2& from, Index stride) {
  const half2* from_alias = reinterpret_cast<const half2*>(&from);
...
template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE RivetEigen::half pfirst<Packet4h2>(
    const Packet4h2& a) {
...
template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Packet4h2
plset<Packet4h2>(const RivetEigen::half& a) {
...
template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE RivetEigen::half predux<Packet4h2>(
    const Packet4h2& a) {
  const half2* a_alias = reinterpret_cast<const half2*>(&a);
...
template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE RivetEigen::half predux_max<Packet4h2>(
    const Packet4h2& a) {
  const half2* a_alias = reinterpret_cast<const half2*>(&a);
...
template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE RivetEigen::half predux_min<Packet4h2>(
    const Packet4h2& a) {
  const half2* a_alias = reinterpret_cast<const half2*>(&a);
...
template <>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE RivetEigen::half predux_mul<Packet4h2>(
    const Packet4h2& a) {
  const half2* a_alias = reinterpret_cast<const half2*>(&a);
