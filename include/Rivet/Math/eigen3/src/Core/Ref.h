  ...
  EIGEN_DEVICE_FUNC bool construct(Expression& expr)
  {
    ...
    EIGEN_STATIC_ASSERT(
      ...
      || ( PlainObjectType::IsVectorAtCompileTime
            && ((int(PlainObjectType::RowsAtCompileTime)==RivetEigen::Dynamic
              || int(Expression::ColsAtCompileTime)==RivetEigen::Dynamic
              || int(PlainObjectType::RowsAtCompileTime)==int(Expression::ColsAtCompileTime))
            &&  (int(PlainObjectType::ColsAtCompileTime)==RivetEigen::Dynamic
              || int(Expression::RowsAtCompileTime)==RivetEigen::Dynamic
...
/** \class Ref
  ...
  *  - <a href="http://stackoverflow.com/questions/21132538/correct-usage-of-the-eigenref-class">Correct usage of the RivetEigen::Ref<> class</a>
  *
