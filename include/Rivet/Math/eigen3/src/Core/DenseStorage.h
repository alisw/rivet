...
struct plain_array_helper {
  ...
  static void copy(const plain_array<T, Size, MatrixOrArrayOptions, Alignment>& src, const RivetEigen::Index size,
  ...
  template<typename T, int Size, int MatrixOrArrayOptions, int Alignment>
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
  static void swap(plain_array<T, Size, MatrixOrArrayOptions, Alignment>& a, const RivetEigen::Index a_size,
                   plain_array<T, Size, MatrixOrArrayOptions, Alignment>& b, const RivetEigen::Index b_size) {
    if (a_size < b_size) {
